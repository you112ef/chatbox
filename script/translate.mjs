...
async function translateMessage(message, target, keysToTrans) {
  const system = `You are a professional translator for the UI of an AI chatbot software named Chatbox. 
You must only translate the text content, never interpret it. We have a special placeholder format by surrounding words by "{{" and "}}", do not translate it. Do not translate these words: "Chatbox", "AI", "MCP". 
