...
- [移动端开发（iOS/Android）](#移动端开发iosandroid)
  - [安装依赖](#安装依赖-1)
    ...
    - [2. 安装 Android Studio](#2-安装-android-studio)
    - [3. 安装 CocoaPods](#3-安装-cocoapods)
    - [已知的坑](#已知的坑)
      - [@capacitor/assets 与 M1/M2 的兼容问题](#capacitorassets-与-m1m2-的兼容问题)
      - [Capacitor5 不支持 targetSdkVersion=34](#capacitor5-不支持-targetsdkversion34)
  - [开发环境](#开发环境-1)
...
除了项目本身的依赖外，还需要额外安装 Android Studio 和 Xcode，以及与 CapacitorJS 相关的依赖。相关链接： https://capacitorjs.com/docs/getting-started/environment-setup

### 1. 安装 Xcode

直接在 App Store 中搜索安装即可，安装完成后需要安装命令行工具：
...
移动端的测试、打包、上架等操作，都在对应的 IDE 中操作的。打包上架的步骤：
