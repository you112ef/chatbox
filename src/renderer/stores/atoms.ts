...
export const showWordCountAtom = focusAtom(settingsAtom, (optic) =>
    optic.prop('showWordCount')
);
export const showTokenCountAtom = focusAtom(settingsAtom, (optic) =>
    optic.prop('showTokenCount')
);
export const showModelNameAtom = focusAtom(settingsAtom, (optic) =>
    optic.prop('showModelName')
);
...
export const configsAtom = atomWithStorage<Config>(
    'configs',
    defaults.configs(),
    storage
);
...
// myCopilots
export const myCopilotsAtom = atomWithStorage<CopilotDetail[]>(
    'myCopilots',
    [],
    storage
);
...
export const currentSessionNameAtom = focusAtom(currentSessionAtom, (optic) =>
    optic.prop('name')
);
export const currentMessagesAtom = focusAtom(currentSessionAtom, (optic) =>
    optic.prop('messages').valueOr([])
);
export const currentMessageAtomsAtom = splitAtom(currentMessagesAtom);

export const currsentSessionPicUrlAtom = focusAtom(
    currentSessionAtom,
    (optic) => optic.prop('picUrl')
);
