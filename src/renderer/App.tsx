...
function Main() {
    ...
    // 是否展示设置窗口
    const [openSettingWindow, setOpenSettingWindow] = React.useState<
        'ai' | 'display' | null
    >(null);
    useEffect(() => {
        setTimeout(() => {
    ...
    const messageScrollRef = useRef<{ msgId: string; smooth?: boolean } | null>(
        null
    );
    useEffect(() => {
    ...
    const [configureChatConfig, setConfigureChatConfig] =
        React.useState<Session | null>(null);

    const [sessionClean, setSessionClean] = React.useState<Session | null>(
        null
    );
                    ...
                    >
                        ...
                        >
                            ...
                            <MenuList>
                                ...
                                <MenuItem
                                    onClick={() => setOpenCopilotWindow(true)}
                                >
                                    <ListItemIcon>
                                        <IconButton>
                                ...
                                <MenuItem
                                    onClick={() => setOpenAboutWindow(true)}
                                >
                                    <ListItemIcon>
                                        <IconButton>
