                ...
                >
                    <Badge color="primary" variant="dot" invisible={false}>
                        <Button
                            ...
                            onClick={() =>
                                api.openLink(
                                    `https://chatboxai.app/redirect_app/check_update/${props.lang}`
                                )
                            }
                        >
                            {t('Check Update')}
                    ...
                    <Button
                        ...
                        onClick={() =>
                            api.openLink(
                                `https://chatboxai.app/redirect_app/homepage/${props.lang}`
                            )
                        }
                    >
                        {t('Homepage')}
                    ...
                    <Button
                        ...
                        onClick={() =>
                            api.openLink(
                                `https://chatboxai.app/redirect_app/feedback/${props.lang}`
                            )
                        }
                    >
                        {t('Feedback')}
                    ...
                    <Button
                        ...
                        onClick={() =>
                            api.openLink(
                                `https://chatboxai.app/redirect_app/roadmap/${props.lang}`
                            )
                        }
                    >
                        {t('Roadmap')}
                ...
                >
                    ...
                    <Stack spacing={2} direction="row">
                        <Button
                            ...
                            onClick={() =>
                                api.openLink(
                                    `https://chatboxai.app/redirect_app/donate/${props.lang}`
                                )
                            }
                        >
                            {t('Donate')}
                        ...
                        <Button
                            ...
                            onClick={() =>
                                api.openLink(
                                    `https://chatboxai.app/redirect_app/become_sponsor/${props.lang}`
                                )
                            }
                        >
